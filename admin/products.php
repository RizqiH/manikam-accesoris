...
<head>
  ...
  <title>Manikam Aksesoris | Products Management</title>
    ...
    <div class="modal-content">
      ...
      <form id="addProductForm">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="productPhoto">Photo URL</label>
            <input type="text" class="form-control" id="productPhoto" placeholder="Optional">
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <form id="editProductForm">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="editProductPhoto">Photo URL</label>
            <input type="text" class="form-control" id="editProductPhoto">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <button class="btn btn-sm btn-warning" onclick="editProduct(${row.id}, '${row.nama_produk}', ${row.harga}, '${row.foto}')">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="btn btn-sm btn-danger" onclick="console.log('Delete button clicked for ID:', ${row.id}); deleteProduct(${row.id});">
...
function addProduct() {
    const productData = {
        nama_produk: $('#productName').val(),
        harga: $('#productPrice').val(),
        foto: $('#productPhoto').val()
    };
    ...
    $.ajax({
        ...
        error: function(xhr) {
            ...
            try {
                ...
                errorMessage = xhr.statusText || 'Server error occurred';
            }
            Swal.fire({
                icon: 'error',
                title: 'Error!',
...
function editProduct(id, name, price, photo) {
    $('#editProductId').val(id);
    $('#editProductName').val(name);
    $('#editProductPrice').val(price);
    $('#editProductPhoto').val(photo);
...
function updateProduct() {
    const productData = {
        ...
        harga: $('#editProductPrice').val(),
        foto: $('#editProductPhoto').val()
    };
